# -----------------------------------------------------------------------------
# Multi Cluster - Path-Based Routing Environment
# -----------------------------------------------------------------------------
...
#
# Traffic is routed using paths on a single domain:
#   - domain.com/ (root - main app)
#   - domain.com/api/* (runtime API)
...
terraform {
  ...
  #   prefix = "openhands/multi-cluster-path"
  # }
}
...
# -----------------------------------------------------------------------------
# DNS Records for Path-Based Routing
# -----------------------------------------------------------------------------
