...
Usage: {{ include "openhands.componentLabels" (dict "context" . "component" "server") }}
*/}}
{{- define "openhands.componentLabels" -}}
{{ include "openhands.labels" .context }}
app.kubernetes.io/component: {{ .component }}
{{- end }}

{{/*
Component selector labels — extends selector labels with a component identifier.
Usage: {{ include "openhands.componentSelectorLabels" (dict "context" . "component" "server") }}
*/}}
{{- define "openhands.componentSelectorLabels" -}}
{{ include "openhands.selectorLabels" .context }}
app.kubernetes.io/component: {{ .component }}
{{- end }}
